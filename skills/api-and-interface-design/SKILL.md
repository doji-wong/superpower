...
description: Use this skill when designing REST endpoints, defining clear contracts between frontends and services, or establishing the stable public interface that a module exposes to other teams.
---
