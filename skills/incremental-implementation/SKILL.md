...
description: Use to build features step by step, implementing tasks from a plan as small, verifiable slices, and committing each working increment to ship changes in thin slices behind feature flags.
---
