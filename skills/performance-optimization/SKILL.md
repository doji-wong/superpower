...
description: Profile and optimize performance bottlenecks, fix slow load times and N+1 database queries, add right indexes, and improve Core Web Vitals like LCP across dashboards and endpoints.
---
