...
description: Builds and refactors pages into responsive, mobile-friendly, and WCAG-compliant accessible UIs using reusable components with proper state management and keyboard support.
---
