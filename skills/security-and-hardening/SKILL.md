...
description: Use this skill to audit handlers for vulnerabilities, harden endpoints that process user-supplied data, and ensure login flows are safe against the OWASP top ten.
---
