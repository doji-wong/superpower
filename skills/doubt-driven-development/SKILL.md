...
description: Applies a fresh-context adversarial review to cross-examine every assumption, stress plans for hidden failure modes, and verify reasoning during high-stakes production operations.
---
